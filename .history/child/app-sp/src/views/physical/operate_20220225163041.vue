    ...
    >
        <div>
            ...
            >
                ...
                <el-table-column prop="power_status_name" label="主机来源" v-if="oper_type==='shelves'"></el-table-column>
            </el-table>
            <el-select v-model="recycleId" v-if="oper_type==='shelves'">
              <el-option v-for="item in recycle_list" :key="item.key" :label="item.label"></el-option>
            </el-select>
        </div>
