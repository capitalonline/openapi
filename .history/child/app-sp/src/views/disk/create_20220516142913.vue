                        ...
                        <div class="card_inline">
                            ...
                            >
                                ...
                                <div class="prompt_message">当前区域已购买
                                    ...
                                    <span class="num_message">{{getResetCapacity(inn.ecs_goods_id)data_disk_info && (showResetVolume[data_disk_info[inn.ecs_goods_id].disk_feature] - inn.disk_size*inn.amount)>=0 ? (showResetVolume[data_disk_info[inn.ecs_goods_id].disk_feature] - inn.disk_size*inn.amount) : 0}}</span> 
