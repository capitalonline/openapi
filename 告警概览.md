...
* [API概览](#api概览)
  ...
  * [17.DescribeAlarmObject](#17describealarmobject)
...
**描述**：增加报警策略的规则【CCS/BMS/ECS/WAN/PAAS暂不支持】
...
**描述**：删除报警策略的规则【CCS/BMS/ECS/PAAS暂不支持】
...
### 17.DescribeAlarmObject
  **Action:DescribeAlarmObject**
...
| Data             | dict   | {}      | 返回数据     |
| product_type     | string | WAN     | 产品类型     |
| product_type_str | string | 公网      | 产品类型中文描述 |
| link_instances   | list   | []      | 告警资源列表   |
| instance_id      | string | ''      | 告警资源ID   |
| instance_name    | string | ''      | 告警资源名称   |
    ...
    "Data": [
        {
            "link_instances": [
                {
                    "instance_id": "0546be68-d653-4a69-ac97-9dda41fe65a7",
                    "instance_name": "云安全测试(公网1)"
                }
            ],
            "product_type": "WAN",
            "product_type_str": "公网"
