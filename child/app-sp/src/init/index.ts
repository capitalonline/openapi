...
export async function getUserInfo() {
  ...
  if (resData.code == 'Success') {
    ...
    store.commit('SET_AUTH_INFO', {...resData.data.permission_dict,alarm_info:[...resData.data.permission_dict.alarm_info,'alarm_create','alarm_detail'],disk_list:[...resData.data.permission_dict.disk_list,'disk_detail']});
  }
}
