...
const host_status={//error为新增状态，异常
  ...
  maintenance:{power:[],host:['lock'],vm:1,msg:'已选主机需为已锁定状态且已选主机上不能有虚拟机运行',label:'设置维护'},
  offline_maintenance:{power:[],host:['offline','online','exception'],vm:1,msg:'已选主机需为在线或离线状态且已选主机上不能有虚拟机运行',label:'离线维护'},
  finish:{power:[],host:['maintenance'],msg:'已选主机需为维护中状态',label:'完成维护'},
  ...
  lock:{power:['running'],host:['offline','online'],msg:'已选主机需为在线或离线状态',label:'锁定'},
