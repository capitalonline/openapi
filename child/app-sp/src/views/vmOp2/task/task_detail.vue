<template>
  <div>
    <div class="head-box">
      {{event_name}}
      <el-button type="primary" plain style="float: right;margin-top: 7px" @click="FnReturn">返回</el-button>
    </div>
    <div class="content m-top20">
      ...
      >
        ...
        <el-table-column prop="customer_id" lable="客户ID" :filter-multiple="false" column-key="customer_id" :filters="customer_id_list"></el-table-column>
