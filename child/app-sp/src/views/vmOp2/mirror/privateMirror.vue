<template>
    <div>
        ...
        >
            ...
            <el-table-column prop="os_id" label="镜像ID" min-width="160px"></el-table-column>
            <el-table-column prop="display_name" label="镜像名称" min-width="120px" :show-overflow-tooltip="true"></el-table-column>
            ...
            <el-table-column prop="init_mirror" label="初始镜像" min-width="140px" :show-overflow-tooltip="true">
            ...
            <el-table-column prop="update_time" label="更新时间" sortable="custom" width="140"></el-table-column>
