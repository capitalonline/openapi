<template>
    <div>
      ...
      >
        ...
        <el-table-column prop="az_id" label="可用区"></el-table-column>
        <el-table-column prop="event_id" label="任务ID"></el-table-column>
        <el-table-column prop="event_name" label="任务名称"></el-table-column>
        <el-table-column prop="event_state_name" label="任务状态" :filter-multiple="false" column-key="status" :filters="status_list">
          <template slot-scope="scope">
            <span :class="[scope.row.status === 'failed'|| scope.row.status === 'part_fail' ? 'err' : '']">{{scope.row.event_state_name}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="implementation_name" label="失败类型"></el-table-column>
        <el-table-column prop="1" label="当前执行流程"></el-table-column>
        <el-table-column prop="2" label="失败原因"></el-table-column>
        ...
        <el-table-column prop="finish_time" label="完成时间" sortable="custom">
          <template slot-scope="scope">
