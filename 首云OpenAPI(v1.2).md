# 目录
   ...
   * [首云公开API文档](#首云公开api文档)
     ...
     * [虚拟数据中心相关](#虚拟数据中心相关)
       ...
       * [21.DescribePubAccountSubject](#21DescribePubAccountSubject)
     * [私有网络相关](#私有网络相关)
...
| SubjectId      | int | 否       | 123                                                  | 本账户测试金Id(DescribePubAccountSubject 获取)                      |
...
### 21.DescribePubAccountSubject

**Action:DescribePubAccountSubject**
...
|    Message     | String | Success                                                      |                返回信息                |
|      Data      |  Dict  | {}                                                           |                返回数据列表                |
|     Id         |  String| 123                                                          |                测试金ID,(SubjectId)    |
|     Name     | String | 测试金                                                          |               测试金名称                |
|    Duration    | int | 20                                                 |                测试周期                |
|   BeginTime   | String | '2023-08-26'                                                      |                测试金开始时间                |
